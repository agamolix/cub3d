...
void	init_mlx(t_data *data)
{
    ...
    data->text_n.addr = mlx_get_data_addr(data->text_n.text_ptr, &data->text_n.bpp, &data->text_n.line_len, &data->text_n.endian);
    ...
    data->text_s.addr = mlx_get_data_addr(data->text_s.text_ptr, &data->text_s.bpp, &data->text_s.line_len, &data->text_s.endian);
    ...
    data->text_w.addr = mlx_get_data_addr(data->text_w.text_ptr, &data->text_w.bpp, &data->text_w.line_len, &data->text_w.endian);
    ...
    data->text_e.addr = mlx_get_data_addr(data->text_e.text_ptr, &data->text_e.bpp, &data->text_e.line_len, &data->text_e.endian);
